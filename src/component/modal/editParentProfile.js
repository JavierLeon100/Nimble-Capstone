...
export default function editParentProfile({showModal}){

    const userIocn = <AntDesign name="user" size={40} color="black" />
    const editButton = <Button w="90" ml="10">Edit</Button>
        ...
        <ScrollView>
            ...
            <AntDesign name="user" size={50} color="black" />
                ...
                <Center mt="6">
                    ...
                    <VStack mt="9" h="80">
                        <Text fontWeight="bold" fontSize="lg" textAlign="center">Children</Text>
                        <FlatGrid 
                        itemDimension={180}
                        spacing={18}
                        data={exampleArray}
